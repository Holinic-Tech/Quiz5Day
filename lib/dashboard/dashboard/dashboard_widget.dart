                                              ...
                                              valueOrDefault<String>(
                                                () {
                                                  if (FFAppState()
                                                    ...
                                                    return 'Denser hair and noticeable regrowth that fills in sparse areas, so I can have peace of mind and feel beautiful again .';
                                                  } else if (FFAppState()
                                                      .quizProfile
                                                      .qaPairs
                                                      .contains(
                                                    ...
                                                    return 'Smoother, frizz-free hair that makes me feel confident and put-together every day.';
                                                  } else if (FFAppState()
                                                      .quizProfile
                                                      .qaPairs
                                                      .contains(
                                                    ...
                                                    return 'A calm, itch and flake free scalp that allows me to go through my day without constant distraction or embarrassment from scratching.';
                                                  } else if (FFAppState()
                                                      .quizProfile
                                                      .qaPairs
                                                      .contains(
                                                    ...
                                                    return 'Stronger, more resilient hair that I can style daily without guilt or worry about damage.';
                                                  } else {
                                    ...
                                    valueOrDefault<String>(
                                      () {
                                        if (FFAppState()
                                          ...
                                          return 'https://assets.hairqare.co/5D_Damage%20Hair_Bottom_LD.webp';
                                        } else {
                      ...
                      child: Padding(
                        ...
                        child: RichText(
                          ...
                          text: TextSpan(
                            children: [
                              TextSpan(
                                text: 'Based on your answers, you just need',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.inter(
                                          ...
                                          child: RichText(
                                            ...
                                            text: TextSpan(
                                              children: [
                                                ...
                                                TextSpan(
                                                  text:
                                                      'that fit your unique hair concerns.',
                                                  style: TextStyle(
                                                    color: Color(0xFF1E191D),
                                                    fontWeight: FontWeight.w300,
                                                    fontSize: 16.0,
